...
UI-only requests → apply only the UI guidelines. “Add this feature end-to-end” → apply application-development guidelines and, for the UI part, keep Layer 3 only.
...
- If the doc’s **§7 Project-specific** is filled, follow those paths and roles. If empty, infer Layer 1–2 from the codebase using the doc’s principles and layout rules.
...
Project-specific rules override this file when they exist.
